<template>
	<view class="pay-result-container">
		...
		<view class="result-content">
			<!-- 成功状态 -->
			<view v-if="paymentStatus === 'success'" class="success-result">
				<view class="result-icon success">
					<text>✓</text>
				</view>
				<view class="result-title">支付成功</view>
				<view class="result-desc">您的订单已支付成功，我们会尽快为您发货</view>
			...
			<!-- 失败状态 -->
			<view v-else class="fail-result">
				<view class="result-icon fail">
					<text>✗</text>
				</view>
				<view class="result-title">支付失败</view>
				<view class="result-desc">支付过程中出现问题，请重新尝试</view>
		...
		<view class="action-buttons">
			<view v-if="paymentStatus === 'success'" class="btn-group">
