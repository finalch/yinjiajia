...
const breadcrumbs = computed(() => {
  ...
  const result = [{ path: '/dashboard', name: '首页' }]
...
const updateUserInfo = () => {
  const merchantInfo = authService.getUserInfo()
  if (merchantInfo) {
    userName.value = merchantInfo.merchant_number || '商家管理员'
  }
}
        ...
        <el-aside width="250px" class="sidebar">
          ...
          >
            ...
            <el-sub-menu index="products">
              ...
              <el-menu-item index="/groups">商品分类</el-menu-item>
            </el-sub-menu>
